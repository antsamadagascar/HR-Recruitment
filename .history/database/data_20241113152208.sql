    ...
    VALUES ('John Doe', 'RH@gmail.com', 'ivo', sha1('john_doe'), 1);

    -- Insérer un utilisateur inactif (etat = 0)
    INSERT INTO utilisateur (nom, email, username, mot_de_passe, etat)
    VALUES ('Jane Smith', 'user@gmail.com', 'jane_smith', sha1('jane_smith'), 0);

    -- Insérer un utilisateur suspendu (etat = 2)
    INSERT INTO utilisateur (nom, email, username, mot_de_passe, etat)
    VALUES ('Alex Johnson', '', 'alex_johnson', sha1('alex_johnson'), -1);
